...
CONFIG_DIR="$HOME/.config/taskthing"
...
fetch_asset_urls() {
  ...
  # Asset do CLI principal (taskthing-*)
...
install_config() {
  ...
  CONFIG_URL="$RAW_BASE/src/config/default_config.json"
...
main() {
  echo ""
  echo -e "${BOLD}  🔔 taskthing Installer${RESET}"
  echo ""
